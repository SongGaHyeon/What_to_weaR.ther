...
def cardi():
    ...
    f = open(r"가디건_data.csv", 'w', encoding='CP949', newline='')
...
def cottonpants():
    ...
    f = open(r"면바지_data.csv", 'w', encoding='CP949', newline='')
    csvWriter = csv.writer(f)
    items = browser.find_elements_by_css_selector("#searchList li.li_box")
...
def slacks():
    ...
    f = open(r"슬랙스_data.csv", 'w', encoding='CP949', newline='')
    csvWriter = csv.writer(f)
    items = browser.find_elements_by_css_selector("#searchList li.li_box")
...
def lightknit():
    ...
    f = open(r"얇은니트_data.csv", 'w', encoding='CP949', newline='')
    csvWriter = csv.writer(f)
    items = browser.find_elements_by_css_selector("#searchList li.li_box")
...
def jeanjacket():
    ...
    f = open(r"청자켓_data.csv", 'w', encoding='CP949', newline='')
    csvWriter = csv.writer(f)
    items = browser.find_elements_by_css_selector("#searchList li.li_box")
