...
def winter_pants():
    ...
    f = open(r"겨울바지_data.csv", 'w', encoding='CP949', newline='')
...
def glove():
    ...
    f = open(r"장갑_data.csv", 'w', encoding='CP949', newline='')
    csvWriter = csv.writer(f)
    items = browser.find_elements_by_css_selector("#searchList li.li_box")
...
def pading():
    ...
    f = open(r"패딩_data.csv", 'w', encoding='CP949', newline='')
    csvWriter = csv.writer(f)
